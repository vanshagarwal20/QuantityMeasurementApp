...
public class Quantity<U extends IMeasurable> {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1 foot to inches : " + q1.convertTo(LengthUnit.INCH));
        ...
        Quantity<LengthUnit> q4 = new Quantity<>(6.0, LengthUnit.INCH);

        System.out.println("Subtraction implicit : " + q3.subtract(q4));
        System.out.println("Subtraction explicit : " + q3.subtract(q4, LengthUnit.INCH));
